...
/**
 * Servlet implementation class BuscarPorNumero
 */
@WebServlet("/BuscarPorNumero")
public class BuscarPorNumero extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			int usuId = teldao.IdUsuarioPorNumero(numero);
			
			Usuario usuario = usudao.read(usuId);
			...
			out.println("<p>Telefono no encontrado</p>");
		}
	}
